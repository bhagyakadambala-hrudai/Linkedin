...
function buildTextPrompt(role, skills, topic) {
...
function buildImagePrompt(role, topic) {
...
function buildCombinedPrompt(role, skills, topic) {
  return `You are a professional LinkedIn content writer.
...
async function publishToLinkedIn(accessToken, personId, content) {
